...
# This script is created by CYBIECY.
...
echo -e "${GREEN}This is made by ----------------${ENDCOLOR}${RED}CYBIECY${ENDCOLOR}${GREEN}-----------------${ENDCOLOR}"


echo -e "${GREEN}########################################################################################################################${ENDCOLOR}"

echo -e " ${YELLOW}/$$$$$$$$ /$$   /$$ /$$$$$$$$${ENDCOLOR}"                                                           
echo -e "${YELLOW}|__  $$__/| $$  | $$| $$_____/${ENDCOLOR}"                                                             
echo -e "   ${YELLOW}| $$   | $$  | $$| $$${ENDCOLOR}"                                                             
echo -e "   ${YELLOW}| $$   | $$$$$$$$| $$$$$${ENDCOLOR}"                                                             
echo -e "   ${YELLOW}| $$   | $$__  $$| $$__/${ENDCOLOR}"                                                             
echo -e "   ${YELLOW}| $$   | $$  | $$| $$${ENDCOLOR}"                                                             
echo -e "   ${YELLOW}| $$   | $$  | $$| $$$$$$$$${ENDCOLOR}"                                                             
echo -e "   ${YELLOW}|__/   |__/  |__/|________/${ENDCOLOR}"                                                             
                                                                                            
                                                                                            
                                                                                            
echo -e " ${YELLOW}/$$$$$$$  /$$   /$$  /$$$$$$  /$$$$$$$   /$$$$$$  /$$   /$$ /$$   /$$ /$$$$$$$$ /$$     /$$${ENDCOLOR}"
echo -e "${YELLOW}| $$__  $$| $$  | $$ /$$__  $$| $$__  $$ /$$__  $$| $$  | $$| $$$ | $$|__  $$__/|  $$   /$$/${ENDCOLOR}"
echo -e "${YELLOW}| $$  \ $$| $$  | $$| $$  \__/| $$  \ $$| $$  \ $$| $$  | $$| $$$$| $$   | $$    \  $$ /$$/${ENDCOLOR}"
echo -e "${YELLOW}| $$$$$$$ | $$  | $$| $$ /$$$$| $$$$$$$ | $$  | $$| $$  | $$| $$ $$ $$   | $$     \  $$$$/${ENDCOLOR}"
echo -e "${YELLOW}| $$__  $$| $$  | $$| $$|_  $$| $$__  $$| $$  | $$| $$  | $$| $$  $$$$   | $$      \  $$/${ENDCOLOR}"
echo -e "${YELLOW}| $$  \ $$| $$  | $$| $$  \ $$| $$  \ $$| $$  | $$| $$  | $$| $$\  $$$   | $$       | $$${ENDCOLOR}"
echo -e "${YELLOW}| $$$$$$$/|  $$$$$$/|  $$$$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$/| $$ \  $$   | $$       | $$${ENDCOLOR}"
echo -e "${YELLOW}|_______/  \______/  \______/ |_______/  \______/  \______/ |__/  \__/   |__/       |__/${ENDCOLOR}"
                                                                                            
                                                                                            
                                                                                            
echo -e " ${YELLOW}/$$$$$$$   /$$$$$$   /$$$$$$  /$$   /$$${ENDCOLOR}"
echo -e "${YELLOW}| $$__  $$ /$$__  $$ /$$__  $$| $$  /$$/${ENDCOLOR}"                                      
echo -e "${YELLOW}| $$  \ $$| $$  \ $$| $$  \__/| $$ /$$/${ENDCOLOR}"                                                  
echo -e "${YELLOW}| $$$$$$$/| $$$$$$$$| $$      | $$$$$/${ENDCOLOR}"                                                  
echo -e "${YELLOW}| $$____/ | $$__  $$| $$      | $$  $$${ENDCOLOR}"                                                  
echo -e "${YELLOW}| $$      | $$  | $$| $$    $$| $$\  $$${ENDCOLOR}"                                                  
echo -e "${YELLOW}| $$      | $$  | $$|  $$$$$$/| $$ \  $$${ENDCOLOR}"                                                  
echo -e "${YELLOW}|__/      |__/  |__/ \______/ |__/  \__/${ENDCOLOR}"                              
...
echo -e "  ${GREEN}/$$$$$$  /$$     /$$ /$$$$$$$  /$$$$$$ /$$$$$$$$  /$$$$$$  /$$     /$$${ENDCOLOR}"
echo -e " ${GREEN}/$$__  $$|  $$   /$$/| $$__  $$|_  $$_/| $$_____/ /$$__  $$|  $$   /$$/${ENDCOLOR}"
echo -e "${GREEN}| $$  \__/ \  $$ /$$/ | $$  \ $$  | $$  | $$      | $$  \__/ \  $$ /$$/${ENDCOLOR}" 
echo -e "${GREEN}| $$        \  $$$$/  | $$$$$$$   | $$  | $$$$$   | $$        \  $$$$/${ENDCOLOR}"  
echo -e "${GREEN}| $$         \  $$/   | $$__  $$  | $$  | $$__/   | $$         \  $$/${ENDCOLOR}"   
echo -e "${GREEN}| $$    $$    | $$    | $$  \ $$  | $$  | $$      | $$    $$    | $$${ENDCOLOR}"    
echo -e "${GREEN}|  $$$$$$/    | $$    | $$$$$$$/ /$$$$$$| $$$$$$$$|  $$$$$$/    | $$${ENDCOLOR}"   
echo -e " ${GREEN}\______/     |__/    |_______/ |______/|________/ \______/     |__/${ENDCOLOR}" 

echo -e "${GREEN}########################################################################################################################${ENDCOLOR}"


echo -e "${GREEN}HOPE YOU WILL HIT A BOUNTY $ :-)${ENDCOLOR}"
